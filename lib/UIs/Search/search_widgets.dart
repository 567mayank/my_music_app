...
class _SearchResultCardState extends State<SearchResultCard> {
  void fetchingFunction(Map<String, dynamic> results) {
    setState(() {
          ...
          if (value == FetchingStatus.success) {
            return Expanded(
              ...
              child: Column(
                children: [
                  searchResultCard(
                      "Top", SearchControllerClass.results['topQuery'] ?? []),
                  searchResultCard(
                      "Songs", SearchControllerClass.results['songs'] ?? []),
                  searchResultCard(
                      "Albums", SearchControllerClass.results['albums'] ?? []),
                  searchResultCard("Artists",
                      SearchControllerClass.results['artists'] ?? []),
                  searchResultCard("Playlists",
